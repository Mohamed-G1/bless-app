...
import com.nat.greco.screens.courierDetails.domain.models.RefusalReasonsModel
...
fun RefusalReasonsBottomSheet(
    refusalList: List<RefusalReasonsModel>,
    ...
    LazyColumn(
        ...
        item {
            ...
            AppButton(
                ...
                onClick = { onClick.invoke(selectedRefusal, selectedRefusalId, comments) }
            )
        }
...
fun RefusalItem(
    ...
    Column {
        Row(
            ...
            Text(
                text = model.refusalReasonsNameAr.orEmpty(),
                style = CompactTypography.labelMedium.copy(color = Color.Gray)
            )

            RadioButton(
                selected = alreadySelectedRefusalId == model.refusalReasonsId,
                onClick = {
                    onClick.invoke(model.refusalReasonsNameAr.orEmpty(), model.refusalReasonsId ?: 0)
                },
