...
fun CollectScreen(
    ...
    isComingFromConfirmOrder: Boolean
) {
            ...
            item {
                ...
                Row(
                    ...
                    Text(
                        ...
                        style = CompactTypography.labelMedium
                    )

                    Text(
                        text = state.totalDept.toString() + " EGP",
                ...
                Row(
                    ...
                    Text(
                        text = state.lastTotalOrder.toString() + " EGP",
                        style = CompactTypography.labelMedium.copy(color = Color.Gray)
                    )
...
fun JournalItem(
    ...
    Row(
        ...
        RadioButton(
            selected = alreadySelected == item.id,
            onClick = {
                onClick(item.id)
            },
...
private fun CollectScreenPreview() {
    CollectScreen(state = CollectState(), customerId = 0, isComingFromConfirmOrder = false)
}